...
def get_rotation_angle(alignment_marks):
    ''' Gets the rotaion angle of the chip

    args:
        alignment_marks: a PositionList of lenght 2
    
    returns:
        float 
    '''
    assert len(alignment_marks) == 2
